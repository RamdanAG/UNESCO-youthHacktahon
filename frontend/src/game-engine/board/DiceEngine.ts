// DiceEngine
// Handles dice roll RNG and roll animation trigger.\n// NOTE: this is NOT used for movement (movement uses a fixed budget, see\n// MovementEngine). This is for combat-flavor rolls / future initiative rolls.
...
export class DiceEngine {
  ...
  roll(sides: number = 6): number {
    // TODO: real RNG (consider server-authoritative roll via /api/v1/dice/roll)
